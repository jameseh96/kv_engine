...
public:
     ...
     */
    LabelGuard withDefaultLabel(std::string_view label,
     ...
     *
     *  Avoids relying on implicit conversions, and means unintentional
     *  implicit conversions from other types will not be allowed unnoticed.
     *
     */
    template <typename T>
